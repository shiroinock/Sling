...
import { KarabinerConfig, Profile, Rule, SimpleModification } from '@/types/karabiner'
  ...
  devtools(
    persist(
      (set, get) => ({
        ...
        selectProfile: (index) => set({ 
          selectedProfileIndex: index,
          selectedRuleIndex: null 
        }),

        selectRule: (index) => set({ 
        ...
        updateProfile: (index, profile) => set((state) => {
          if (!state.config) return state
        ...
        updateRule: (ruleIndex, rule) => set((state) => {
          if (!state.config) return state
        ...
        deleteRule: (ruleIndex) => set((state) => {
          if (!state.config) return state
          ...
          const newSelectedRuleIndex = state.selectedRuleIndex === ruleIndex 
            ? null 
        ...
        addSimpleModification: (modification) => set((state) => {
          if (!state.config) return state
        ...
        updateSimpleModification: (index, modification) => set((state) => {
          if (!state.config) return state
        ...
        deleteSimpleModification: (index) => set((state) => {
          if (!state.config) return state
