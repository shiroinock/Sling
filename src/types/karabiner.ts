...
export const COMMON_KEY_CODES = [
  ...
  'delete_forward', 'end', 'page_down', 'right_arrow', 'left_arrow',
  'down_arrow', 'up_arrow', 'keypad_num_lock', 'keypad_slash', 'keypad_asterisk',
  'keypad_hyphen', 'keypad_plus', 'keypad_enter', 'keypad_1', 'keypad_2',
  ...
  'paste', 'find', 'mute', 'volume_up', 'volume_down',
  'locking_caps_lock', 'locking_num_lock', 'locking_scroll_lock',
  'keypad_comma', 'keypad_equal_sign_as400',
  ...
  'fn', 'display_brightness_down', 'display_brightness_up',
  'mission_control', 'launchpad', 'dashboard', 'illumination_down',
  'illumination_up', 'rewind', 'play_or_pause', 'fastforward',
  'eject', 'apple_display_brightness_down', 'apple_display_brightness_up',
  'apple_top_case_display_brightness_down', 'apple_top_case_display_brightness_up'
] as const

export const MODIFIER_KEYS = [
  'left_control', 'left_shift', 'left_option', 'left_command',
  'right_control', 'right_shift', 'right_option', 'right_command',
  'caps_lock', 'fn', 'command', 'control', 'option', 'shift', 'any'
] as const

export const CONSUMER_KEY_CODES = [
  'power', 'display_brightness_increment', 'display_brightness_decrement',
  'keyboard_illumination_increment', 'keyboard_illumination_decrement',
  'rewind', 'play_or_pause', 'fastforward', 'mute', 'volume_increment',
  'volume_decrement', 'eject', 'apple_display_brightness_increment',
  'apple_display_brightness_decrement', 'apple_top_case_display_brightness_increment',
